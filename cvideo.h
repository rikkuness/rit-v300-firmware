...
#define piofreq_1_390 4.8f
#define piofreq_1_420 4.8f
...
#define colour_base                                                            \
  0x10 // Start colour; for monochrome version this relates to black level
       // voltage
...
#define gpio_base 3
#define gpio_count 5
#define sync_gpio 7 // choose GPIO 4 for sync (or another free GPIO)
...
void cvideo_configure_pio_dma(PIO pio, uint sm, uint dma_channel,
                              uint transfer_size, size_t buffer_size,
